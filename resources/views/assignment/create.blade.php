...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Buat Assignment Baru</h1>
            <p class="text-gray-600 mt-2">Isi form di bawah untuk membuat assignment baru untuk kelas Anda</p>
        </div>
