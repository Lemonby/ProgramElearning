<x-mentor-layout>
    <div class="max-w-3xl mx-auto space-y-8">
        ...
        <div class="flex items-center justify-between pb-4 border-b border-white/5">
            <div>
                <h1 class="text-3xl font-extrabold text-white tracking-tight">Edit Sesi Pertemuan</h1>
                <p class="text-slate-400 mt-1 text-sm">Perbarui detail pertemuan virtual untuk kelas Anda.</p>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    >
                        ...
                        <option value="online" class="bg-[#1A1435] text-white" {{ old('type', $meeting->type) === 'online' ? 'selected' : '' }}>Online (Google Meet / Zoom)</option>
                        <option value="offline" class="bg-[#1A1435] text-white" {{ old('type', $meeting->type) === 'offline' ? 'selected' : '' }}>Offline (Tatap Muka)</option>
                    </select>
