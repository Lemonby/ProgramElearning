        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('meetings.update', $meeting->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" placeholder="Masukkan judul meeting" value="{{ old('title', $meeting->title) }}" required
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" name="meeting_date" id="meeting_date" value="{{ old('meeting_date', $meeting->meeting_date) }}" required
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="meeting_time" id="meeting_time" value="{{ old('meeting_time', $meeting->meeting_time) }}" required
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="offline" {{ old('type', $meeting->type) === 'offline' ? 'selected' : '' }}>Offline</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" placeholder="Deskripsikan topik atau materi yang akan dibahas"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('description', $meeting->description) }}</textarea>
                        </div>
