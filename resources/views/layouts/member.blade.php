        ...
        <div class="min-h-screen flex bg-gradient-to-br from-[#0c0721] via-[#160f38] to-[#251052] overflow-hidden">
            ...
            <div x-show="sidebarOpen" 
                ...
                <div x-show="sidebarOpen" 
                    ...
                    <div class="flex flex-shrink-0 items-center mb-10">
                        <span class="text-3xl font-black tracking-tight text-white uppercase flex items-center">
                    ...
                    <nav class="flex flex-1 flex-col justify-between">
                        <div class="space-y-2">
                            ...
                            <a href="{{ route('dashboard.member') }}" 
                               class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all {{ request()->routeIs('dashboard.member') ? 'bg-white/10 text-white font-bold border-l-4 border-purple-500 shadow-lg shadow-purple-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5' }}">
                            ...
                            <a href="{{ route('member-materials.index') }}" 
                               class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all {{ request()->routeIs('member-materials.*') ? 'bg-white/10 text-white font-bold border-l-4 border-purple-500 shadow-lg shadow-purple-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('submissions.index') }}" 
                               class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all {{ request()->routeIs('submissions.*') ? 'bg-white/10 text-white font-bold border-l-4 border-purple-500 shadow-lg shadow-purple-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('member.attendance.history') }}" 
                               class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all {{ request()->routeIs('member.attendance.history') ? 'bg-white/10 text-white font-bold border-l-4 border-purple-500 shadow-lg shadow-purple-500/5' : 'text-slate-400 hover:text-white hover:bg-white/5' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <aside class="hidden lg:flex lg:flex-shrink-0 flex-col w-64 bg-[#0B071E] border-r border-white/5 p-6 min-h-screen">
                <div class="flex items-center mb-10 pl-2">
                    <span class="text-2xl font-black tracking-tight text-white uppercase flex items-center">
                        Edu<span class="text-purple-500">Code</span>
                    </span>
                </div>
